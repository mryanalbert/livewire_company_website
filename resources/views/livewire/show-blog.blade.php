                                        ...
                                        <article class="blog-post">
                                            <div class="post-slider slider-sm rounded">
                                                {{-- <img loading="lazy" decoding="async"
                                                    src=" {{ asset('front/images/blog/post-4.jpg') }}"
                                                    alt="Post Thumbnail"> --}}
                                                ...
                                                @if ($article->image != '')
                                                    <img loading="lazy" decoding="async"
                                                        ...
                                                        alt="Post Thumbnail"
                                                        style="height:200px;object-fit:cover;width:100%;border:3px solid rgb(243, 243, 243);" />
                                                @endif
                                            ...
                                            <div class="pt-4">
                                                ...
                                                <p>Heading example Here is example of hedings. You can use this heading
                                                    by following…</p>
                                                <a wire:navigate href="{{ route('blogDetail', $article->id) }}"
                                                    class="text-primary fw-bold"
                                                    aria-label="Read the full article by clicking here">Read More
                                                </a>
                                            </div>
                                        </article>
                                    </div>
                        ...
                        <ul class="list-unstyled widget-list">
                            @if ($categories->isNotEmpty())
                                @foreach ($categories as $category)
                                    <li>
                                        <a wire:navigate
                                            href="{{ route('blog') . '?categorySlug=' . $category->slug }}">
                                            {{ $category->name }}
                                        </a>
                                    </li>
                                @endforeach
